...
const starts = async (helga = new WAConnection()) => {
	...
	console.log(color('\n> GitHub : ','red'), color(`Rafaell,'white'))
	console.log(color('> YouTube : ','red'), color(`Rafaell`,'white'))
console.log(color('> TikTok : ','red'), color(`@rafael929525`,'white'))
console.log(color('> Instagram : ','red'), color(`@rafael929525`,'white'))
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   helga.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6289675970738@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
...
contentText: `${masuk}`,
footerText: `𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 ٬࿊⃟𝑹𝒂𝒇𝒂𝒆𝒍シ︎`, 
buttons: gbutsan,
headerType: 4 }
